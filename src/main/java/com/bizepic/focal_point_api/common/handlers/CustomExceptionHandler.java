package com.bizepic.focal_point_api.common.handlers;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * MissingServletRequestPartException: This exception is thrown when when the part of a multi-part request not found
